...
# example.com/registry-manager-operator-bundle:$VERSION and example.com/registry-manager-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/registry-manager-operator
